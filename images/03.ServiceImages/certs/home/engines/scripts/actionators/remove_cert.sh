...
if test -f /home/certs/store/services/wap/certs/${domain_name}.crt
 then
  sudo -n /home/engines/scripts/engines/_remove_cert.sh service wap/certs/${domain_name}.crt
  sudo -n /home/engines/scripts/engines/_remove_cert.sh service wap/keys/${domain_name}.key
fi
