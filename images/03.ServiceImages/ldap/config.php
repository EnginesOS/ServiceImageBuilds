...
$servers->setValue('server','name','Engines LDAP Server');
...
$servers->setValue('server','base',array('dc=engines,dc=internal'));
...
/* The DN of the user for phpLDAPadmin to bind with. For anonymous binds or
 ...
 binds. */
$servers->setValue('login','bind_id','cn=admin,dc=engines,dc=internal');
