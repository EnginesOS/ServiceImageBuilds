...
echo Contents of /client/var/log >> /client/var/log/fs_setup.log
ls /client/var/log > /client/var/log/fs_setup.log

echo Contents of /client/log  >> /client/var/log/fs_setup.log

ls /client/log >> /client/var/log/fs_setup.log

echo Contents of /client/state >> /client/var/log/fs_setup.log
ls /client/state >> /client/var/log/fs_setup.log

echo Contents of dest/fs >> /client/var/log/fs_setup.log

ls /dest/fs >> /client/var/log/fs_setup.log

echo Contents of /home/fs >> /client/var/log/fs_setup.log
...
chmod g+w  -R /client/state
	...
	for file in `cat /home/fs_src/vol_dir_maps`
	 do
	  ...
	  echo Install dir $file in /dest/fs/$volume >>/home/fs_src/test.out
	  ls  /dest/fs/ >>/home/fs_src/test.out
	 done
	 for file in `cat /home/fs_src/vol_file_maps`
	 do
	  volume=`grep "$file " /home/fs_src/vol_dir_maps | awk '{print $2}'`
	  echo Install file $file in /dest/fs/$volume >>/home/fs_src/test.out
	  ls  /dest/fs/ >>/home/fs_src/test.out
	 done
